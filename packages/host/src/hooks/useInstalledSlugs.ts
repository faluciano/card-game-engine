...
// Loads installed ruleset slugs from FileRulesetStore on boot and
// syncs them into CouchKit host state so all clients see them.
...
/**
 * Loads installed ruleset slugs from filesystem on mount and
 * dispatches SET_INSTALLED_SLUGS so all clients see which games
